    ...
    <div class="relative bg-white rounded-lg shadow ">
        ...
        <div class="p-4 md:p-5">
            <form method="post" class="space-y-4" action="{{ route('userLogin') }}">
                @csrf
                <div>
                    <label for="email" class="block mb-2 text-sm font-medium text-blue">Your
                        email</label>
                ...
                <div class="flex justify-between">
                    <div class="flex items-start">
                        ...
                        <label for="remember"
                            class="ms-2 text-sm font-medium text-blue">Remember
                            me</label>
                    </div>
                    <a href="/forgetpassword" class="text-sm text-blue hover:underline">Forget
                        Password?</a>
                </div>
                <button type="submit"
