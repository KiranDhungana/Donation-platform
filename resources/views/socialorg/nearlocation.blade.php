...
<body>
    ...
    @foreach($item as $json => $value)
        ...
        @endphp
            ...
            {{-- <p>Name: </p>
            <p>Category: {{ $decodedData['catagory'] }}</p>
            <p>Description: {{ $decodedData['description'] }}</p>
            <p>Latitude: {{ $decodedData['latitude'] }}</p>
            <p>Longitude: {{ $decodedData['longitude'] }}</p>
            <p>Register Date: {{ $decodedData['registerdate'] }}</p>
            <p>Province: {{ $decodedData['province'] }}</p>
            <p>District: {{ $decodedData['district'] }}</p>
            <p>ID: {{ $decodedData['id'] }}</p>
            <p>Approved Status: {{ $decodedData['approvedstatus'] }}</p> --}}
