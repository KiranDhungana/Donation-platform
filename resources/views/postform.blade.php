...
<body>
    ...
    <div class="post_form_container pt-[5rem] bg-blue-900 flex flex-col h-[100vh]">
        <h1 class="text-white text-center text-xl m-5">Fill the form with correct information</h1>
        ...
        <form class="w-1/2 mx-auto">
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <label for="floating_company"
                        class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Street
                        Name</label>
                </div>
            </div>
            ...
            <div class="relative my-5 flex justify-between">
                ...
                <div class="provience">
                    ...
                    <select id="prov" class="bg-blue-700 text-white p-1">
                ...
                <div class="district">
                    ...
                    <select id="dis" class="bg-blue-700 text-white p-1">
                ...
                <div class="target">
                    ...
                    <div class="slidecontainer">
                        <label for="myRange" class="text-white">Target Amount</label>
                        <input type="range" min="1" max="10000" value="50" class="slider" id="myRange">
                        <p class="text-white">Amount: Rs.<span id="demo"></span></p>
                    </div>
                </div>
            ...
            <div class="citizenship_container my-5 flex justify-around">
                <div class="w-1/2">
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file_input">Upload
                        Citizenship</label>
                    <input
                        class="block w-full text-sm text-gray-900 border border-gray-500 rounded-lg cursor-pointer bg-blue-900 dark:text-gray-400 focus:outline-none  dark:placeholder-gray-400"
            ...
            <div class="images_container my-5">
                ...
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="multiple_files">Upload
                    Photos</label>
                <input
                    class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-blue-900 text-white dark:placeholder-gray-400"
